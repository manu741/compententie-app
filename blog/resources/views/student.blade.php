...
{{--                                        <input value="{{ $student->firstname }}" type="text"  placeholder="Voornaam" name="firstname" id="firstname" autocomplete="given-name" class=" p-1.5 px-3 border-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('firstname') border-red-500 @enderror">--}}
...
{{--                                        <input value="{{ $student->lastname }}" type="text" name="lastname" placeholder="Achternaam"  id="lastname" class="  p-1.5 px-3 border-2  mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('lastname') border-red-500 @enderror">--}}
{{--                                        @error('lastname')--}}
{{--                                        <div class="text-red-500 mt-2 text-sm">--}}
{{--                                            {{ $message }}--}}
{{--                                        </div>--}}
...
{{--                                        <input value="{{ $student->studentnr  }}" type="text" name="studentnr" placeholder="studentnr"  id="studentnr"  class=" p-1.5 px-3 border-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('studentnr') border-red-500 @enderror">--}}
{{--                                        @error('studentnr')--}}
{{--                                        <div class="text-red-500 mt-2 text-sm">--}}
{{--                                            {{ $message }}--}}
{{--                                        </div>--}}
...
{{--                                        <input value="{{ $student->email  }}" type="text" name="email" placeholder="E-mail adres"  id="email"  class=" p-1.5 px-3 border-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('email') border-red-500 @enderror">--}}
{{--                                        @error('email')--}}
{{--                                        <div class="text-red-500 mt-2 text-sm">--}}
{{--                                            {{ $message }}--}}
{{--                                        </div>--}}
                ...
                <div class="mt-5 md:mt-0 md:col-span-2 active" id="personal_data" data-tab-content>
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-5 gap-5">
                            ...
                            <div class="col-span-5 sm:col-span-3 lg:col-span-3">
                                <label for="email" class="block text-sm font-medium text-gray-700">Student nummer</label>
                                <div>
                                    {{ $student->studentnr }}
                                </div>
                            </div>
