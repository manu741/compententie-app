...
@section('content')
    ...
    <svg class="bg-white dark:bg-gray-600 fill-current text-gray-100 dark:text-gray-700" width="full" height="full" viewBox="0 0 2200 71" fill="rgb(55, 65, 81)" xmlns="http://www.w3.org/2000/svg" >
        <path d="M2200 0L0 71V0H2200Z" fill=""/>
    </svg>
    <div class="bg-white dark:bg-gray-600 overflow-hidden w-full justify-center">
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full p-4 sm:w-1/2 lg:w-1/3">
                    <div style="text-align: center" class="px-10 py-12 bg-white dark:bg-gray-600 rounded-lg block text-black dark:text-white">
                        <div style="align-content: center" class="justify-center flex my-2">
                            <svg class="fill-current text-blue-500 dark:text-green-400" width="64" height="64"  viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="justify-center text-xl my-1 font-bold">Kenmerk</h3>
                        At eripuit signiferumque sea, vel ad mucius molestie, cu labitur iuvaret vulputate sed.
                        <div class="py-2">
                            <a href="#" class="text-blue-500 hover:text-blue-700 dark:text-green-400 dark:hover:text-green-600 font-medium">Link</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full p-4 sm:w-1/2 lg:w-1/3">
                    <div style="text-align: center" class="px-10 py-12 bg-white dark:bg-gray-600 rounded-lg text-black dark:text-white">
                        <div style="align-content: center" class="justify-center flex my-2">
                            <svg class="fill-current text-blue-500 dark:text-green-400" width="64" height="64" viewBox="0 0 24 24" fill="" style="align-content: center" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19 22H5C4.44772 22 4 21.5523 4 21V13H2L11.292 3.70698C11.4796 3.51921 11.7341 3.4137 11.9995 3.4137C12.2649 3.4137 12.5194 3.51921 12.707 3.70698L22 13H20V21C20 21.5523 19.5523 22 19 22ZM10 15H14V20H18V11.828L12 5.82798L6 11.828V20H10V15Z"/>
                            </svg>
                        </div>
                        <h3 class="justify-center text-xl my-1 font-bold">Kenmerk</h3>
                        At eripuit signiferumque sea, vel ad mucius molestie, cu labitur iuvaret vulputate sed.
                ...
                <div class="w-full p-4 sm:w-1/2 lg:w-1/3">
                    <div style="text-align: center" class="px-10 py-12 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg">
                        <div style="align-content: center" class="justify-center flex my-2">
                            <svg class="fill-current text-blue-500 dark:text-green-400" width="64" height="64" viewBox="0 0 24 24" fill="rgb" xmlns="http://www.w3.org/2000/svg">
