...
@section('content')
    ...
    <div class="w-full h-full bg-white dark:bg-gray-600 font-bold text-black dark:text-white">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 w-8/12 p-8">
                ...
                <div class="w-full my-2">
                    <label>Toelichting
                        ...
                        <textarea id="toelichtingName" placeholder="Omdat..."
                ...
                <div class="w-full my-2">
                    <label class=" my-2 font-normal">Tot welk niveau rijkt mijn competentiebeheersing voor de competentie
                        (competentie naam)?
        ...
        <div class="py-4">
            <div class="flex justify-center">
                <a href=""
                    class="w-2/12 flex justify-center border border-transparent text-base font-medium rounded-md text-white bg-blue-500 dark:bg-green-500 dark:hover:bg-green-600 hover:bg-blue-700 px-3 py-2">
                    Opslaan
                </a>
            </div>
        </div>
