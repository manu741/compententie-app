        ...
        <div class="flex justify-center">
            <div class="bg-gray-200 dark:bg-gray-700 w-8/12 rounded mb-4">
                <span class="flex mb-8 mt-8 ml-12">
                    Welke competenties neem je op in deze POP-Cylcus?
                </span>
                ...
                <div class="mt-2 mb-2">
                    <span class="ml-12 mr-8">Indicator:</span>
                    <div class="relative inline-flex">
                        <svg class="w-2 h-2 absolute top-0 right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232"><path d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z" fill="#648299" fill-rule="nonzero"/></svg>
                        <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                ...
                <div class="flex mt-10 ml-12 mb-4">
                    ...
                    <a href="" class="w-4/12 h-10 flex items-center justify-center px-8 py-3 ml-10 mt-2 mb-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-400 dark:bg-gray-700 dark:text-green-400 dark:border-green-400 hover:bg-indigo-500 md:py-4 md:text-lg md:px-10">
        ...
        <div class="flex justify-center">
            <div class="bg-gray-200 dark:bg-gray-700 w-8/12 rounded mb-4">
                <span class=" mb-8 ml-12">
                    ...
                    <span class="flex mb-4 ml-12">
                        Wie/wat heb je nodig en wanneer ga je de activiteit uitvoeren?
                    </span>
