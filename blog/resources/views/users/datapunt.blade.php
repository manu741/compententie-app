...
@section('content')
    ...
    <div class="w-full h-full bg-gray-100 dark:bg-gray-600 font-bold text-black dark:text-white">
        ...
        <div class="flex justify-center">
            ...
            <div class="w-8/12 bg-gray-100 dark:bg-gray-600 rounded-lg">
        ...
        <div class="flex justify-center">
            <div class="bg-gray-200 dark:bg-gray-700 w-8/12 rounded-b mb-4">
                ...
                <div class="flex mt-10 ml-12 mb-4">
                    <a href="" class="w-3/12 h-10 flex items-center justify-center px-8 py-3 mr-10 mt-2 mb-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 dark:bg-green-500 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                        Datapunt toevoegen
                    </a>
                    ...
                    <a href="" class="w-2/12 h-10 flex items-center justify-center px-8 py-3 mt-2 mb-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-400 dark:bg-gray-700 dark:text-green-400 dark:border-green-400 hover:bg-indigo-500 md:py-4 md:text-lg md:px-10">
                        Refresh
                    </a>
                </div>
            </div>
                    ...
                    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="overflow-hidden sm:rounded-lg">
                                ...
                                <table class="min-w-full mb-10 max-w-xl divide-y divide-gray-200 dark:divide-gray-800 border-gray-800 shadow border-2">
