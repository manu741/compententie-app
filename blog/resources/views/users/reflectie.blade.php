...
@section('content')
    ...
    <div class="w-full h-full bg-white dark:bg-gray-600 font-bold text-black dark:text-white">
        ...
        <form enctype="multipart/form-data" action="{{ route('popreflectie.store') }}" method="post">
            @csrf
            <div class="flex justify-center">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 w-8/12 rounded mb-4">
                    ...
                    <div class="relative inline-flex">
                        ...
                        <select class="border border-gray-300 text-gray-600 bg-white hover:border-gray-400 focus:outline-none appearance-none px-3 py-2  dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500 dark:hover:border-gray-800 hover:border-gray-400" style="width:180px;">
                            ...
                            @foreach($reflecties as $reflectie)
                                <option value="{{$reflectie->competentie}}"> {{$reflectie->competentie}}</option>
                            @endforeach
                ...
                <div class="mt-2 mb-2">
                    ...
                    <div class="relative inline-flex">
                        <svg class="w-2 h-2 absolute top-0 right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232"><path d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z" fill="#648299" fill-rule="nonzero"/></svg>
                        <select id="niveau" class="border border-gray-300 text-gray-600 bg-white hover:border-gray-400 focus:outline-none appearance-none px-3 py-2 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500 dark:hover:border-gray-800 hover:border-gray-400" style="width:140px;">
                ...
                <div class="mt-2 mb-2">
                    ...
                    <div class="relative inline-flex">
                        ...
                        <select class="border border-gray-300 text-gray-600 bg-white hover:border-gray-400 focus:outline-none appearance-none px-3 py-2  dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500 dark:hover:border-gray-800 hover:border-gray-400" style="width:140px;">
                            @foreach($reflecties as $reflectie)
                                <option value="{{$reflectie->indicator}}"> {{$reflectie->indicator}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="flex mt-10 ml-12 mb-4">
                    <button type="submit" class="w-5/12 h-10 flex items-center justify-center px-8 py-3 mr-10 mt-2 mb-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 dark:bg-green-500 hover:bg-blue-700 dark:hover:bg-green-600 md:py-4 md:text-lg md:px-10">
                        Reflectie toevoegen
                    </button>

                    <button class="w-5/12 h-10 flex items-center justify-center px-8 py-3 mr-10 mt-2 mb-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 dark:bg-green-500 hover:bg-blue-700 dark:hover:bg-green-600 md:py-4 md:text-lg md:px-10">
        ...
        <div class="flex justify-center">
            <div class="bg-gray-100 dark:bg-gray-700 w-8/12 rounded mb-4">
                <div class="flex flex-col ml-12 mr-12 p-4">
        ...
        <div class="flex justify-center bg-white dark:bg-gray-600">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 dark:text-white font-bold w-8/12 rounded p-8">
...
{{--            document.getElementById('toelichtingName').value = price;--}}
{{--            document.getElementById('niveauName').value = price2;--}}
{{--            document.getElementById('cijferName').value = price3;--}}
{{--            document.getElementById('complimentName').value = price4;--}}
{{--        });--}}
