...
@section('content')
    <div class="w-full h-full dark:bg-gray-600 font-bold text-black dark:text-white">
        ...
        <div class="flex justify-center">
            <div class=" dark:bg-gray-600 w-8/12 px-8">

                <div class="w-full my-2">
                    <label class=" my-2">Pop-cyclus:
                        <div class="my-2 relative inline-flex">
                    ...
                    <div class="my-2 relative inline-flex">
                        <svg class="w-2 h-2 absolute top-0 right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232"><path d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z" fill="#648299" fill-rule="nonzero"/></svg>
                        <select class="border border-gray-300 text-gray-600 bg-white hover:border-gray-400 focus:outline-none appearance-none px-3 py-2 dark:bg-gray-500 dark:text-gray-400 dark:border-gray-600 dark:hover:border-gray-700 hover:border-gray-400" style="width:250px;">
